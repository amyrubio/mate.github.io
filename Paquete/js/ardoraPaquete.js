...
taboaContidos[0]=new act("sociales","sociales","","<object width='100%' height='420' type='text/html' data='juego01/juego01.htm'></object>",false,"",true,false,true);
taboaContidos[1]=new act("lenguaje","lenguaje","","<object width='100%' height='420' type='text/html' data='leng/leng.htm'></object>",false,"",true,false,true);
taboaContidos[2]=new act("mate","mate","","<object width='100%' height='420' type='text/html' data='mate/mate.htm'></object>",false,"",true,false,true);
